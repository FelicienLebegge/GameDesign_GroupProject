...
public class Cutter : MonoBehaviour
{
    ...
    public static void Cut(GameObject originalGameObject, Vector3 contactPoint, Vector3 cutNormal)
    {
        ...
        //Checking for when no mesh is available when performing cut
        ...
        //Reassigning collider to left mesh
        ...
        //Assigning material to left mesh
        ...
        //Assigning material to right mesh
        ...
        //Assuring collider won't have holes
        ...
        //Strength of mesh being pushed away when cut
        right.transform.position = new Vector3(right.transform.position.x, right.transform.position.y - 0.05f, right.transform.position.z + 0.01f);
    ...
    private static void SeparateMeshes(GeneratedMesh leftMesh,GeneratedMesh rightMesh, Plane plane, List<Vector3> addedVertices)
    {
        for (int i = 0; i < originalMesh.subMeshCount; i++)
        {
            ...
            for (int j = 0; j < subMeshIndices.Length; j+=3)
            {
                ...
                //We are now using the plane.getside function to see on which side of the cut our trianle is situated or if it might be cut through
    ...
    /// </summary>
    private static void CutTriangle(Plane plane,MeshTriangle triangle, bool triangleALeftSide, bool triangleBLeftSide, bool triangleCLeftSide, GeneratedMesh leftMesh, GeneratedMesh rightMesh, List<Vector3> addedVertices)
    {
        ...
        //Calculating verts that need to be added to the left side
        ...
        //calculating normal and uv of added triangle
        ...
        //Calculating verts that need to be added to the right side
        ...
        //Calculating bormal and uv of added triangle
